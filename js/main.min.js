...
var owl=$(".content"),navigation=["kdo-jsme","co-umime","jak-pracujeme","co-jsme-dokazali"],EB={initCarousel:function(){owl.owlCarousel({navigation:!0,slideSpeed:1e3,paginationSpeed:1e3,pagination:!1,singleItem:!0,rewindNav:!1,navigationText:['<img src="img/sipka2.png">','<img src="img/sipka.png">'],addClassActive:!0,mouseDrag:!1,afterAction:function(){EB.carouselChange(this),owl.off("mousewheel"),EB.initScroll()}})},destroyCarousel:function(){void 0!==owl&&void 0!==owl.data("owlCarousel")&&owl.data("owlCarousel").destroy()},initScroll:function(){setTimeout(function(){owl.on("mousewheel",".owl-wrapper",function(o){owl.trigger(o.deltaY>0?"owl.prev":"owl.next"),o.preventDefault()})},2e3)},loadJump:function(){var o=EB.getURLParam(window.location,"s"),e=navigation.indexOf(o);void 0!==owl&&e>-1&&owl.trigger("owl.jumpTo",e)},anchorSlide:function(o,e){o.preventDefault(),o.stopPropagation();var n=$(e).attr("href"),t=$(n).offset().top;$("html, body").animate({scrollTop:t},1e3)},showTarget:function(o){var e=$(o).data("target"),n=$(o).data("animation")||"fadeIn";$(e).show().addClass(n)},tooltipShow:function(o){if($(o).data("tooltip")){var e=$(o).data("tooltip"),n=$(o).offset().top+$(o).outerHeight(),t=$(o).offset().left+$(o).outerWidth()-$(e).outerWidth()/2-20;$(".tooltip").hide(),$(e).css({top:n+"px",left:t+"px"}).show().addClass("fadeIn")}else{var e=o;$(".tooltip").hide(),$(e).show()}},tooltipHide:function(o){var e=$(o).data("tooltip")||o;$(e).hide()},carouselChange:function(o){var e=o.currentItem,n=$("#main-menu"),t=n.children()[e];$("#main-menu li").removeClass("active"),$(t).addClass("active")},menuClick:function(o){var e=$(o).data("section");owl.trigger("owl.goTo",e)},getURLParam:function(o,e){return decodeURI(o.search.replace(new RegExp("^(?:.*[&\\?]"+encodeURI(e).replace(/[\.\+\*]/g,"\\$&")+"(?:\\=([^&]*))?)?.*$","i"),"$1"))}};$(document).ready(function(){$(window).innerWidth()>767?(EB.initCarousel(),$(window).on("mousewheel",function(o){o.preventDefault()})):$("section").css("min-height",$(window).innerHeight())}),$(window).on("load",function(){EB.loadJump()}),$(window).on("resize",function(){$(window).innerWidth()>767?(window.location.hash="",EB.initCarousel(),$(window).on("mousewheel",function(o){o.preventDefault()})):(EB.destroyCarousel(),$(window).off("mousewheel"))}),$("#main-menu").on("click","li",function(){EB.menuClick(this)}),$("#main-menu").on("click","a",function(o){$(window).innerWidth()>767?o.preventDefault():EB.anchorSlide(o,this)}),$(".logo").on("click",function(){$(window).innerWidth()>767&&owl.trigger("owl.goTo",0)}),$(".cloud .arrow, #contact-us").on("click touchend",function(){EB.showTarget(this)}),$(".cloud9 .arrow").on("click",function(){$(this).hide()}),$(".tent, .tooltip").on("mouseenter",function(){$(window).innerWidth()>767&&EB.tooltipShow(this)}),$(".tent, .tooltip").on("mouseleave",function(o){$(window).innerWidth()>767&&"SECTION"===o.relatedTarget.nodeName&&EB.tooltipHide(this)});